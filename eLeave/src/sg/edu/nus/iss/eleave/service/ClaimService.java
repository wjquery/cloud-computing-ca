...
public interface ClaimService {
	...
	public List<Claim> findAllClaimApplicationByEmployee(String employeeId) throws ServiceException;
	public Claim findAllClaimApplicationByEmployee(String employee, int month) throws ServiceException;
	...
	public List<Claim> findClaimByManager(String employeeId) throws ServiceException;
	public List<Claim> findClaimByManager(String employeeId, int month) throws ServiceException;
