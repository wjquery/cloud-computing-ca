		...
		<tr>
			<td>
				<div style="margin: 2px; padding: 5px; width: 960px;">
					...
					<form class="new" action="/leaveType/update" method="post">
						<table class="overview-eleave-items">
							<tbody>
								<tr class="overview-item">
									<td>LeaveTypeId:</td>
									<td><input name="leaveTypeId" type="text" value="${ltype.leaveTypeId}" /></td>
								</tr>
								<tr class="overview-item">
									<td>Leave Type Name:</td>
									<td><input name="leaveTypeName" type="text" value="${ltype.name}" /></td>
								</tr>
								<tr class="overview-item">
									<td>Default Entitlement</td>
									<td><input name="defaultEntitlement" type="text" value='<fmt:formatNumber type="number" maxFractionDigits="0" value="${ltype.defaultEntitlement}" />' /></td>
								</tr>
								<tr class="overview-item">
									<td />
									<td><p>
											<input type="submit" value="Save" class="sbutton" /> &nbsp;
											<a href="/leaveType/findAll" class="sbutton">Back</a>
										</p></td>
								</tr>
							</tbody>
						</table>
